$(document).ready(function () {
    ...
    function showPercentageModal(total) {
        ...
        $('#applyPercentage').click(function() {
            ...
            if (!isNaN(percentage)) {
                ...
                updateStats(increasedTotal, hasilBagi);
            }
    ...
    $("#themeToggle").change(function() {
     ...
     function updateStats(total, modal) {
        $("#totalKeseluruhan").text(formatRupiah(total));
        $("#hasilBagi12").text(formatRupiah(modal));
    }

    // Modify the showPercentageModal function to use the new updateStats function
    function showPercentageModal(total) {
        var percentageModal = document.getElementById('percentageModal');
        percentageModal.classList.add('modal-open');
